...
function Controller() {
    function init(parent) {
        ...
        if ("Ti.UI.TableView" !== parent.apiName && "Ti.UI.ListView" !== parent.apiName) {
    ...
    !__parentSymbol || "Ti.UI.TableView" !== __parentSymbol.apiName && "Ti.UI.ListView" !== __parentSymbol.apiName ? console.debug("[" + $.__widgetId + "] Do not forget to call init() passing a TableView or ListView") : init(__parentSymbol);
    exports.SUCCESS = 1;
    exports.ERROR = 0;
    exports.DONE = -1;
