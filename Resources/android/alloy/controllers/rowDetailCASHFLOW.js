function Controller() {
    ...
    $.__views.__alloyId82.add($.__views.importo);
    ...
    $.__views.__alloyId84.add($.__views.dataOperazione);
    ...
    $.__views.__alloyId86.add($.__views.dataValuta);
    ...
    $.__views.row.add($.__views.__alloyId88);
    ...
    $.__views.__alloyId88.add($.__views.flagOrdinarioStraordinario);
    ...
    $.__views.row.add($.__views.__alloyId90);
    ...
    $.__views.__alloyId90.add($.__views.statoMovimento);
    ...
    $.__views.row.add($.__views.__alloyId92);
    ...
    $.__views.__alloyId92.add($.__views.tipoMovimento);
    ...
    $.__views.__alloyId94.add($.__views.tipoVariabilita);
    ...
    $.__views.__alloyId96.add($.__views.modalitaPagamento);
    ...
    $.__views.__alloyId98.add($.__views.strumentoPagamentoIncasso);
    ...
    $.__views.__alloyId100.add($.__views.fonteLiquidita);
    ...
    $.__views.__alloyId102.add($.__views.tipoFonteLiquidita);
