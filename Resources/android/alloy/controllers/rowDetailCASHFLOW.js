function Controller() {
    function __alloyId133() {
        $.__views.win.removeEventListener("open", __alloyId133);
    ...
    $.__views.win.addEventListener("open", __alloyId133);
    $.__views.__alloyId134 = Ti.UI.createScrollView({
        id: "__alloyId134"
    });
    $.__views.win.add($.__views.__alloyId134);
    ...
    $.__views.__alloyId136.add($.__views.importo);
    ...
    $.__views.__alloyId138.add($.__views.movimento);
    ...
    $.__views.__alloyId140.add($.__views.pagamento);
    ...
    $.__views.__alloyId142.add($.__views.variabilita);
    $.__views.__alloyId144 = Ti.UI.createView({
        layout: "horizontal",
        top: 10,
        id: "__alloyId144"
    });
    $.__views.__alloyId135.add($.__views.__alloyId144);
    ...
    $.__views.__alloyId144.add($.__views.stato);
    $.__views.__alloyId146 = Ti.UI.createView({
        layout: "horizontal",
        top: 10,
        id: "__alloyId146"
    });
    $.__views.__alloyId135.add($.__views.__alloyId146);
    ...
    $.__views.__alloyId146.add($.__views.tipologia);
    ...
    $.__views.__alloyId148.add($.__views.redditi);
    $.__views.__alloyId150 = Ti.UI.createView({
        layout: "horizontal",
        top: 30,
        id: "__alloyId150"
    });
    $.__views.__alloyId135.add($.__views.__alloyId150);
    ...
    $.__views.__alloyId150.add($.__views.datavaluta);
    $.__views.__alloyId152 = Ti.UI.createView({
        layout: "horizontal",
        top: 10,
        id: "__alloyId152"
    });
    $.__views.__alloyId135.add($.__views.__alloyId152);
    ...
    $.__views.__alloyId152.add($.__views.datascadenza);
    ...
    $.__views.__alloyId135.add($.__views.__alloyId154);
    ...
    $.__views.__alloyId154.add($.__views.datapagamento);
