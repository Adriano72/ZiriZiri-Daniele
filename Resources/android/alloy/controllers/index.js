...
function Controller() {
    ...
    $.__views.index.add($.__views.__alloyId199);
    ...
    $.__views.__alloyId199.add($.__views.btn_login);
    ...
    $.__views.index.add($.__views.__alloyId200);
    ...
    $.__views.__alloyId200.add($.__views.remember);
    ...
    $.__views.__alloyId200.add($.__views.forgotPassword);
