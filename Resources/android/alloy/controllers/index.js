...
function Controller() {
    ...
    $.__views.index.add($.__views.__alloyId132);
    ...
    $.__views.__alloyId132.add($.__views.password);
    ...
    $.__views.__alloyId132.add($.__views.btn_login);
    ...
    $.__views.index.add($.__views.__alloyId133);
    ...
    $.__views.__alloyId133.add($.__views.remember);
    ...
    $.__views.__alloyId133.add($.__views.forgotPassword);
