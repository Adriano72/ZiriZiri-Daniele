...
function Controller() {
    ...
    $.__views.index.add($.__views.__alloyId138);
    ...
    $.__views.__alloyId138.add($.__views.password);
    ...
    $.__views.__alloyId138.add($.__views.btn_login);
    ...
    $.__views.index.add($.__views.__alloyId139);
    ...
    $.__views.__alloyId139.add($.__views.remember);
    ...
    $.__views.__alloyId139.add($.__views.forgotPassword);
