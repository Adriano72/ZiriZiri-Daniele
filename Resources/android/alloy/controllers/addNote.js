function Controller() {
    function __alloyId27() {
        $.__views.window.removeEventListener("open", __alloyId27);
        if ($.__views.window.activity) $.__views.window.activity.onCreateOptionsMenu = function(e) {
            ...
            $.__views.salva = e.menu.add(_.pick(__alloyId26, Alloy.Android.menuItemCreateArgs));
            $.__views.salva.applyProperties(_.omit(__alloyId26, Alloy.Android.menuItemCreateArgs));
    ...
    $.__views.window.addEventListener("open", __alloyId27);
    var __alloyId28 = [];
    ...
    $.__views.__alloyId30.add($.__views.content);
