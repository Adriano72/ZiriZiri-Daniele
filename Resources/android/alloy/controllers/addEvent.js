function Controller() {
    function __alloyId46() {
        $.__views.window.removeEventListener("open", __alloyId46);
        if ($.__views.window.activity) $.__views.window.activity.onCreateOptionsMenu = function(e) {
            ...
            $.__views.salva = e.menu.add(_.pick(__alloyId45, Alloy.Android.menuItemCreateArgs));
            $.__views.salva.applyProperties(_.omit(__alloyId45, Alloy.Android.menuItemCreateArgs));
    ...
    $.__views.window.addEventListener("open", __alloyId46);
    var __alloyId47 = [];
    ...
    $.__views.__alloyId48.add($.__views.dataFrom);
    ...
    $.__views.__alloyId49.add($.__views.dataTo);
