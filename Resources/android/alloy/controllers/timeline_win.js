...
function Controller() {
    function __alloyId272() {
        $.__views.win.removeEventListener("open", __alloyId272);
        if ($.__views.win.activity) $.__views.win.activity.onCreateOptionsMenu = function(e) {
            ...
            $.__views.mn_picture = e.menu.add(_.pick(__alloyId268, Alloy.Android.menuItemCreateArgs));
            $.__views.mn_picture.applyProperties(_.omit(__alloyId268, Alloy.Android.menuItemCreateArgs));
            ...
            $.__views.mn_notify = e.menu.add(_.pick(__alloyId269, Alloy.Android.menuItemCreateArgs));
            $.__views.mn_notify.applyProperties(_.omit(__alloyId269, Alloy.Android.menuItemCreateArgs));
            var __alloyId270 = {
            ...
            $.__views.mn_search = e.menu.add(_.pick(__alloyId270, Alloy.Android.menuItemCreateArgs));
            $.__views.mn_search.applyProperties(_.omit(__alloyId270, Alloy.Android.menuItemCreateArgs));
            var __alloyId271 = {
                showAsAction: Ti.Android.SHOW_AS_ACTION_NEVER,
                id: "mn_logout",
                title: "Logout"
            };
            $.__views.mn_logout = e.menu.add(_.pick(__alloyId271, Alloy.Android.menuItemCreateArgs));
            $.__views.mn_logout.applyProperties(_.omit(__alloyId271, Alloy.Android.menuItemCreateArgs));
    ...
    function syncTimeline(e) {
        ...
        syncTimeline.opts || {};
        var models = __alloyId319.models;
        var len = models.length;
        var rows = [];
        for (var i = 0; len > i; i++) {
            var __alloyId273 = models[i];
            __alloyId273.__transform = transformData(__alloyId273);
            var __alloyId275 = Ti.UI.createTableViewRow({
                backgroundColor: "#F9F9F9",
                className: "itemrow",
                height: 170
            });
            rows.push(__alloyId275);
            mostraDettaglioEvento ? __alloyId275.addEventListener("click", mostraDettaglioEvento) : __defers["__alloyId275!click!mostraDettaglioEvento"] = true;
            ...
            var __alloyId279 = Ti.UI.createImageView({
                ...
                height: 70,
                borderRadius: 4,
                image: "undefined" != typeof __alloyId273.__transform["catImage"] ? __alloyId273.__transform["catImage"] : __alloyId273.get("catImage")
            });
            ...
            var __alloyId282 = Ti.UI.createLabel({
                top: 0,
                width: Ti.UI.SIZE,
                height: Ti.UI.SIZE,
                color: "#999",
                ...
                wordWrap: false,
                left: 0,
                text: "undefined" != typeof __alloyId273.__transform["postDate"] ? __alloyId273.__transform["postDate"] : __alloyId273.get("postDate")
            });
            __alloyId281.add(__alloyId282);
            var __alloyId283 = Ti.UI.createView({
                touchEnabled: false,
                height: Ti.UI.SIZE,
                layout: "horizontal",
                width: 100,
            ...
            var __alloyId284 = Ti.UI.createImageView({
                ...
                left: 5,
                top: 0,
                image: "undefined" != typeof __alloyId273.__transform["rating_1"] ? __alloyId273.__transform["rating_1"] : __alloyId273.get("rating_1")
            });
            __alloyId283.add(__alloyId284);
            var __alloyId285 = Ti.UI.createImageView({
                width: 15,
                height: 15,
                left: 5,
                top: 0,
                image: "undefined" != typeof __alloyId273.__transform["rating_2"] ? __alloyId273.__transform["rating_2"] : __alloyId273.get("rating_2")
            });
            __alloyId283.add(__alloyId285);
            var __alloyId286 = Ti.UI.createImageView({
                width: 15,
                height: 15,
                left: 5,
                top: 0,
                image: "undefined" != typeof __alloyId273.__transform["rating_3"] ? __alloyId273.__transform["rating_3"] : __alloyId273.get("rating_3")
            });
            __alloyId283.add(__alloyId286);
            var __alloyId287 = Ti.UI.createImageView({
                width: 15,
                height: 15,
                left: 5,
                top: 0,
                image: "undefined" != typeof __alloyId273.__transform["rating_4"] ? __alloyId273.__transform["rating_4"] : __alloyId273.get("rating_4")
            });
            __alloyId283.add(__alloyId287);
            var __alloyId288 = Ti.UI.createImageView({
                width: 15,
                height: 15,
                left: 5,
                top: 0,
                image: "undefined" != typeof __alloyId273.__transform["rating_5"] ? __alloyId273.__transform["rating_5"] : __alloyId273.get("rating_5")
            });
            __alloyId283.add(__alloyId288);
            var __alloyId289 = Ti.UI.createLabel({
                top: 0,
                width: "70%",
                height: 100,
                color: "#444",
                ...
                ellipsize: true,
                wordWrap: true,
                text: "undefined" != typeof __alloyId273.__transform["name"] ? __alloyId273.__transform["name"] : __alloyId273.get("name")
            });
            __alloyId280.add(__alloyId289);
            ...
            var __alloyId294 = Ti.UI.createLabel({
                top: 10,
                width: 70,
                height: 18,
                color: "#999",
                ...
                touchEnabled: false,
                left: 5,
                text: "undefined" != typeof __alloyId273.__transform["categoria"] ? __alloyId273.__transform["categoria"] : __alloyId273.get("categoria")
            });
            __alloyId292.add(__alloyId294);
            var __alloyId296 = Ti.UI.createView({
                width: Ti.UI.SIZE,
                touchEnabled: false,
                layout: "horizontal",
                left: 40
            });
            __alloyId290.add(__alloyId296);
            ...
            var __alloyId298 = Ti.UI.createLabel({
                ...
                touchEnabled: false,
                left: 5,
                text: "undefined" != typeof __alloyId273.__transform["tag"] ? __alloyId273.__transform["tag"] : __alloyId273.get("tag")
            });
            __alloyId296.add(__alloyId298);
            var __alloyId300 = Ti.UI.createView({
                width: Ti.UI.SIZE,
                touchEnabled: false,
                layout: "horizontal",
                left: 40
            });
            __alloyId290.add(__alloyId300);
            var __alloyId301 = Ti.UI.createImageView({
                width: 20,
                height: 20,
                touchEnabled: false,
            ...
            __alloyId300.add(__alloyId301);
            var __alloyId302 = Ti.UI.createLabel({
                top: 10,
                width: Ti.UI.SIZE,
                height: 18,
                color: "#999",
            ...
            var __alloyId306 = Ti.UI.createImageView({
                ...
                width: 25,
                height: 25,
                image: "undefined" != typeof __alloyId273.__transform["iconEvent"] ? __alloyId273.__transform["iconEvent"] : __alloyId273.get("iconEvent")
            });
            ...
            var __alloyId307 = Ti.UI.createImageView({
                ...
                width: 25,
                height: 25,
                image: "undefined" != typeof __alloyId273.__transform["iconCashFlow"] ? __alloyId273.__transform["iconCashFlow"] : __alloyId273.get("iconCashFlow")
            });
            ...
            var __alloyId308 = Ti.UI.createImageView({
                ...
                width: 25,
                height: 25,
                image: "undefined" != typeof __alloyId273.__transform["iconDocument"] ? __alloyId273.__transform["iconDocument"] : __alloyId273.get("iconDocument")
            });
            __alloyId305.add(__alloyId308);
            var __alloyId309 = Ti.UI.createImageView({
                ...
                width: 25,
                height: 25,
                image: "undefined" != typeof __alloyId273.__transform["iconNote"] ? __alloyId273.__transform["iconNote"] : __alloyId273.get("iconNote")
            });
            __alloyId305.add(__alloyId309);
            var __alloyId310 = Ti.UI.createImageView({
                ...
                width: 25,
                height: 25,
                image: "undefined" != typeof __alloyId273.__transform["iconLink"] ? __alloyId273.__transform["iconLink"] : __alloyId273.get("iconLink")
            });
            __alloyId305.add(__alloyId310);
            var __alloyId311 = Ti.UI.createImageView({
                left: 15,
                top: 10,
                bottom: 10,
                touchEnabled: false,
                ...
                image: "undefined" != typeof __alloyId273.__transform["iconCommunication"] ? __alloyId273.__transform["iconCommunication"] : __alloyId273.get("iconCommunication")
            });
            __alloyId305.add(__alloyId311);
            ...
            __alloyId305.add(__alloyId313);
            var __alloyId315 = Ti.UI.createView({
                height: Ti.UI.SIZE,
                left: 0,
                width: Ti.UI.FILL
            });
            __alloyId313.add(__alloyId315);
    ...
    $.__views.win.addEventListener("open", __alloyId272);
    ...
    var __alloyId319 = Alloy.Collections["Timeline"] || Timeline;
    __alloyId319.on("fetch destroy change add remove reset", syncTimeline);
    ...
    refreshTable ? $.__views.__alloyId320.addEventListener("click", refreshTable) : __defers["$.__views.__alloyId320!click!refreshTable"] = true;
    ...
    $.__views.__alloyId320.add($.__views.bottom_sync);
    ...
    $.__views.__alloyId320.add($.__views.txt_sync);
    ...
    createNewPost ? $.__views.__alloyId321.addEventListener("click", createNewPost) : __defers["$.__views.__alloyId321!click!createNewPost"] = true;
    ...
    $.__views.__alloyId321.add($.__views.bottom_new);
    ...
    $.__views.__alloyId321.add($.__views.txt_new);
    ...
    $.__views.buttonsContainer.add($.__views.__alloyId322);
    gotoToday ? $.__views.__alloyId322.addEventListener("click", gotoToday) : __defers["$.__views.__alloyId322!click!gotoToday"] = true;
    ...
    $.__views.__alloyId322.add($.__views.bottom_today);
    ...
    $.__views.__alloyId322.add($.__views.txt_today);
    exports.destroy = function() {
        __alloyId319.off("fetch destroy change add remove reset", syncTimeline);
    };
    _.extend($, $.__views);
    arguments[0] || {};
    var net = require("net");
    ...
    __defers["__alloyId275!click!mostraDettaglioEvento"] && __alloyId275.addEventListener("click", mostraDettaglioEvento);
    ...
    __defers["$.__views.__alloyId320!click!refreshTable"] && $.__views.__alloyId320.addEventListener("click", refreshTable);
    __defers["$.__views.__alloyId321!click!createNewPost"] && $.__views.__alloyId321.addEventListener("click", createNewPost);
    __defers["$.__views.__alloyId322!click!gotoToday"] && $.__views.__alloyId322.addEventListener("click", gotoToday);
    _.extend($, exports);
}
