function Controller() {
    function __alloyId93() {
        $.__views.win.removeEventListener("open", __alloyId93);
        if ($.__views.win.activity) $.__views.win.activity.onCreateOptionsMenu = function(e) {
            ...
            $.__views.scrivi = e.menu.add(_.pick(__alloyId90, Alloy.Android.menuItemCreateArgs));
            $.__views.scrivi.applyProperties(_.omit(__alloyId90, Alloy.Android.menuItemCreateArgs));
            ...
            $.__views.immagine = e.menu.add(_.pick(__alloyId91, Alloy.Android.menuItemCreateArgs));
            $.__views.immagine.applyProperties(_.omit(__alloyId91, Alloy.Android.menuItemCreateArgs));
            var __alloyId92 = {
                id: "Foto",
                title: "Foto",
            ...
            $.__views.Foto = e.menu.add(_.pick(__alloyId92, Alloy.Android.menuItemCreateArgs));
            $.__views.Foto.applyProperties(_.omit(__alloyId92, Alloy.Android.menuItemCreateArgs));
        }; else {
    ...
    function __alloyId109(e) {
        if (e && e.fromAdapter) return;
        __alloyId109.opts || {};
        var models = __alloyId108.models;
        var len = models.length;
        var rows = [];
        for (var i = 0; len > i; i++) {
            var __alloyId94 = models[i];
            __alloyId94.__transform = {};
            var __alloyId96 = Ti.UI.createTableViewRow({
                className: "itemRow"
            });
            rows.push(__alloyId96);
            mostraDettaglioEvento ? __alloyId96.addEventListener("click", mostraDettaglioEvento) : __defers["__alloyId96!click!mostraDettaglioEvento"] = true;
            ...
            var __alloyId99 = Ti.UI.createImageView({
            ...
            var __alloyId103 = Ti.UI.createLabel({
                ...
                wordWrap: false,
                right: 5,
                text: "undefined" != typeof __alloyId94.__transform["date"] ? __alloyId94.__transform["date"] : __alloyId94.get("date")
            });
            ...
            var __alloyId104 = Ti.UI.createLabel({
                ...
                left: 5,
                text: "undefined" != typeof __alloyId94.__transform["category"] ? __alloyId94.__transform["category"] : __alloyId94.get("category")
            });
            __alloyId100.add(__alloyId104);
            var __alloyId105 = Ti.UI.createLabel({
                ...
                ellipsize: true,
                left: 5,
                text: "undefined" != typeof __alloyId94.__transform["location"] ? __alloyId94.__transform["location"] : __alloyId94.get("location")
            });
            __alloyId100.add(__alloyId105);
            ...
            var __alloyId107 = Ti.UI.createLabel({
                ...
                left: 5,
                text: "undefined" != typeof __alloyId94.__transform["aspects"] ? __alloyId94.__transform["aspects"] : __alloyId94.get("aspects")
            });
    ...
    __defers["__alloyId96!click!mostraDettaglioEvento"] && __alloyId96.addEventListener("click", mostraDettaglioEvento);
    _.extend($, exports);
}
