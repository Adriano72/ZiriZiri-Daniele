...
function Controller() {
    function __alloyId119() {
        $.__views.win.removeEventListener("open", __alloyId119);
        if ($.__views.win.activity) $.__views.win.activity.onCreateOptionsMenu = function(e) {
            ...
            $.__views.mn_salva = e.menu.add(_.pick(__alloyId118, Alloy.Android.menuItemCreateArgs));
            $.__views.mn_salva.applyProperties(_.omit(__alloyId118, Alloy.Android.menuItemCreateArgs));
    ...
    $.__views.win.addEventListener("open", __alloyId119);
    var __alloyId120 = [];
    ...
    $.__views.__alloyId122.add($.__views.importoLabel);
    ...
    $.__views.__alloyId122.add($.__views.importoValue);
    ...
    $.__views.__alloyId122.add($.__views.valutaImg);
    ...
    $.__views.__alloyId126.add($.__views.tipoMovimento);
    ...
    $.__views.__alloyId126.add($.__views.pkrTipoMovimento);
    ...
    __alloyId120.push($.__views.__alloyId128);
    ...
    $.__views.__alloyId129.add($.__views.pagamentoIncasso);
    ...
    $.__views.__alloyId129.add($.__views.pkrPagamentoIncasso);
    ...
    $.__views.__alloyId132.add($.__views.pkrStatoMovimento);
    ...
    __alloyId120.push($.__views.__alloyId134);
    ...
    $.__views.__alloyId135.add($.__views.variabilita);
    ...
    $.__views.__alloyId135.add($.__views.pkrVariabilita);
    ...
    __alloyId120.push($.__views.__alloyId137);
    ...
    $.__views.__alloyId138.add($.__views.leftSubWrapper);
    ...
    $.__views.__alloyId138.add($.__views.rightSubWrapper);
    ...
    __alloyId120.push($.__views.__alloyId140);
    ...
    toggleRedditi ? $.__views.__alloyId141.addEventListener("click", toggleRedditi) : __defers["$.__views.__alloyId141!click!toggleRedditi"] = true;
    $.__views.leftSubWrapper = Ti.UI.createView({
        width: "50%",
        layout: "horizontal",
        left: 0,
    ...
    $.__views.__alloyId141.add($.__views.ovalSwitchContainer);
    ...
    __alloyId120.push($.__views.__alloyId142);
    ...
    $.__views.__alloyId143.add($.__views.rightSubWrapper);
    ...
    __alloyId120.push($.__views.__alloyId145);
    ...
    __alloyId120.push($.__views.__alloyId148);
    ...
    __defers["$.__views.__alloyId141!click!toggleRedditi"] && $.__views.__alloyId141.addEventListener("click", toggleRedditi);
