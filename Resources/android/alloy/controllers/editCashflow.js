...
function Controller() {
    function __alloyId130() {
        $.__views.win.removeEventListener("open", __alloyId130);
        if ($.__views.win.activity) $.__views.win.activity.onCreateOptionsMenu = function(e) {
            ...
            $.__views.mn_salva = e.menu.add(_.pick(__alloyId129, Alloy.Android.menuItemCreateArgs));
            $.__views.mn_salva.applyProperties(_.omit(__alloyId129, Alloy.Android.menuItemCreateArgs));
    ...
    $.__views.win.addEventListener("open", __alloyId130);
    var __alloyId131 = [];
    ...
    $.__views.__alloyId133.add($.__views.importoLabel);
    ...
    $.__views.__alloyId133.add($.__views.importoValue);
    ...
    $.__views.__alloyId133.add($.__views.valutaImg);
    ...
    $.__views.__alloyId137.add($.__views.tipoMovimento);
    ...
    $.__views.__alloyId137.add($.__views.pkrTipoMovimento);
    ...
    $.__views.__alloyId140.add($.__views.pagamentoIncasso);
    ...
    $.__views.__alloyId140.add($.__views.pkrPagamentoIncasso);
    ...
    __alloyId131.push($.__views.__alloyId142);
    ...
    $.__views.__alloyId143.add($.__views.statoMovimento);
    ...
    $.__views.__alloyId143.add($.__views.pkrStatoMovimento);
    ...
    __alloyId131.push($.__views.__alloyId145);
    ...
    $.__views.__alloyId146.add($.__views.variabilita);
    ...
    $.__views.__alloyId146.add($.__views.pkrVariabilita);
    ...
    __alloyId131.push($.__views.__alloyId148);
    ...
    __alloyId131.push($.__views.__alloyId151);
    ...
    toggleRedditi ? $.__views.__alloyId152.addEventListener("click", toggleRedditi) : __defers["$.__views.__alloyId152!click!toggleRedditi"] = true;
    $.__views.leftSubWrapper = Ti.UI.createView({
        width: "50%",
        layout: "horizontal",
        left: 0,
    ...
    $.__views.__alloyId152.add($.__views.ovalSwitchContainer);
    ...
    __alloyId131.push($.__views.__alloyId153);
    ...
    $.__views.__alloyId154.add($.__views.leftSubWrapper);
    ...
    $.__views.__alloyId154.add($.__views.rightSubWrapper);
    ...
    __alloyId131.push($.__views.__alloyId156);
    ...
    $.__views.__alloyId157.add($.__views.leftSubWrapper);
    ...
    $.__views.__alloyId157.add($.__views.rightSubWrapper);
    ...
    __alloyId131.push($.__views.__alloyId159);
    ...
    $.__views.__alloyId160.add($.__views.leftSubWrapper);
    ...
    $.__views.__alloyId160.add($.__views.rightSubWrapper);
    ...
    __defers["$.__views.__alloyId152!click!toggleRedditi"] && $.__views.__alloyId152.addEventListener("click", toggleRedditi);
