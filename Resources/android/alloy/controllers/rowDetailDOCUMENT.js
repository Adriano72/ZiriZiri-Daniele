...
function Controller() {
    function __alloyId228() {
        $.__views.win.removeEventListener("open", __alloyId228);
    ...
    $.__views.win.addEventListener("open", __alloyId228);
    $.__views.__alloyId229 = Ti.UI.createScrollView({
        id: "__alloyId229"
    });
    $.__views.win.add($.__views.__alloyId229);
    ...
    $.__views.__alloyId230.add($.__views.img_preview);
    ...
    $.__views.__alloyId231.add($.__views.titoloLabel);
    ...
    $.__views.__alloyId231.add($.__views.titolo);
    ...
    $.__views.__alloyId232.add($.__views.nomeFileLabel);
    ...
    $.__views.__alloyId232.add($.__views.nomeFile);
    ...
    $.__views.__alloyId233.add($.__views.tipologiaLabel);
    ...
    $.__views.__alloyId233.add($.__views.tipologia);
    ...
    $.__views.__alloyId234.add($.__views.formatoLabel);
    ...
    $.__views.__alloyId234.add($.__views.formato);
    ...
    $.__views.__alloyId235.add($.__views.filesize);
    ...
    $.__views.__alloyId236.add($.__views.caricato);
    ...
    $.__views.__alloyId237.add($.__views.dataDocLabel);
    ...
    $.__views.__alloyId237.add($.__views.dataDoc);
