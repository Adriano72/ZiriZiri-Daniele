function Controller() {
    ...
    $.__views.__alloyId48.add($.__views.format);
    ...
    $.__views.__alloyId50.add($.__views.type);
    ...
    $.__views.__alloyId54.add($.__views.size);
    ...
    $.__views.__alloyId58.add($.__views.img_preview);
