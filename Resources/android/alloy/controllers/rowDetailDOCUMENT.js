...
function Controller() {
    function __alloyId240() {
        $.__views.win.removeEventListener("open", __alloyId240);
    ...
    $.__views.win.addEventListener("open", __alloyId240);
    $.__views.__alloyId241 = Ti.UI.createScrollView({
        id: "__alloyId241"
    });
    $.__views.win.add($.__views.__alloyId241);
    ...
    $.__views.__alloyId242.add($.__views.img_preview);
    ...
    $.__views.__alloyId243.add($.__views.titoloLabel);
    ...
    $.__views.__alloyId243.add($.__views.titolo);
    ...
    $.__views.__alloyId244.add($.__views.nomeFileLabel);
    ...
    $.__views.__alloyId244.add($.__views.nomeFile);
    ...
    $.__views.__alloyId245.add($.__views.tipologiaLabel);
    ...
    $.__views.__alloyId245.add($.__views.tipologia);
    ...
    $.__views.__alloyId246.add($.__views.formatoLabel);
    ...
    $.__views.__alloyId246.add($.__views.formato);
    ...
    $.__views.__alloyId247.add($.__views.filesizeLabel);
    ...
    $.__views.__alloyId247.add($.__views.filesize);
    ...
    $.__views.__alloyId248.add($.__views.filesizeLabel);
    ...
    $.__views.__alloyId248.add($.__views.caricato);
    ...
    $.__views.__alloyId249.add($.__views.dataDocLabel);
    ...
    $.__views.__alloyId249.add($.__views.dataDoc);
