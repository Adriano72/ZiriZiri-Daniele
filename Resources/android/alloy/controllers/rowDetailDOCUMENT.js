function Controller() {
    function __alloyId170() {
        $.__views.win.removeEventListener("open", __alloyId170);
    ...
    $.__views.win.addEventListener("open", __alloyId170);
    ...
    $.__views.__alloyId172.add($.__views.img_preview);
    ...
    $.__views.__alloyId173.add($.__views.titoloLabel);
    ...
    $.__views.__alloyId173.add($.__views.titolo);
    ...
    $.__views.__alloyId174.add($.__views.nomeFileLabel);
    ...
    $.__views.__alloyId174.add($.__views.nomeFile);
    ...
    $.__views.__alloyId175.add($.__views.tipologiaLabel);
    ...
    $.__views.__alloyId175.add($.__views.tipologia);
    ...
    $.__views.__alloyId176.add($.__views.formatoLabel);
    ...
    $.__views.__alloyId176.add($.__views.formato);
    ...
    $.__views.__alloyId177.add($.__views.filesizeLabel);
    ...
    $.__views.__alloyId177.add($.__views.filesize);
    ...
    $.__views.__alloyId178.add($.__views.filesizeLabel);
    ...
    $.__views.__alloyId178.add($.__views.caricato);
    ...
    $.__views.__alloyId172.add($.__views.__alloyId179);
    ...
    $.__views.__alloyId179.add($.__views.dataDocLabel);
    ...
    $.__views.__alloyId179.add($.__views.dataDoc);
