function Controller() {
    ...
    $.__views.row.add($.__views.__alloyId156);
    ...
    $.__views.__alloyId156.add($.__views.tags);
    ...
    $.__views.row.add($.__views.__alloyId158);
    ...
    $.__views.__alloyId158.add($.__views.type);
    ...
    $.__views.row.add($.__views.__alloyId160);
    ...
    $.__views.__alloyId160.add($.__views.content);
    ...
    $.__views.row.add($.__views.__alloyId162);
    ...
    $.__views.__alloyId162.add($.__views.img_preview);
