...
function Controller() {
    ...
    $.__views.row.add($.__views.__alloyId244);
    ...
    $.__views.__alloyId244.add($.__views.tags);
    ...
    $.__views.row.add($.__views.__alloyId246);
    ...
    $.__views.__alloyId246.add($.__views.type);
    ...
    $.__views.row.add($.__views.__alloyId248);
    ...
    $.__views.__alloyId248.add($.__views.content);
    ...
    $.__views.row.add($.__views.__alloyId250);
    ...
    $.__views.__alloyId250.add($.__views.img_preview);
