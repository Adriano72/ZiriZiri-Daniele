...
function Controller() {
    ...
    $.__views.__alloyId220.add($.__views.tags);
    ...
    $.__views.row.add($.__views.__alloyId222);
    ...
    $.__views.__alloyId222.add($.__views.type);
    ...
    $.__views.row.add($.__views.__alloyId224);
    ...
    $.__views.__alloyId224.add($.__views.content);
    ...
    $.__views.row.add($.__views.__alloyId226);
    ...
    $.__views.__alloyId226.add($.__views.img_preview);
