...
function Controller() {
    function __alloyId164() {
        $.__views.win.removeEventListener("open", __alloyId164);
        if ($.__views.win.activity) $.__views.win.activity.onCreateOptionsMenu = function(e) {
            ...
            $.__views.mn_salva = e.menu.add(_.pick(__alloyId163, Alloy.Android.menuItemCreateArgs));
            $.__views.mn_salva.applyProperties(_.omit(__alloyId163, Alloy.Android.menuItemCreateArgs));
    ...
    $.__views.win.addEventListener("open", __alloyId164);
