function Controller() {
    function __alloyId60() {
        $.__views.window.removeEventListener("open", __alloyId60);
        if ($.__views.window.activity) $.__views.window.activity.onCreateOptionsMenu = function(e) {
            ...
            $.__views.salva = e.menu.add(_.pick(__alloyId59, Alloy.Android.menuItemCreateArgs));
            $.__views.salva.applyProperties(_.omit(__alloyId59, Alloy.Android.menuItemCreateArgs));
    ...
    $.__views.window.addEventListener("open", __alloyId60);
