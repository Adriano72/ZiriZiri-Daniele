...
function Controller() {
    function syncCategorie(e) {
        ...
        syncCategorie.opts || {};
        var models = __alloyId209.models;
        ...
        for (var i = 0; len > i; i++) {
            ...
            var __alloyId208 = Ti.UI.createTableViewRow({
                ...
                className: "itemRow",
                color: "#999",
                title: "undefined" != typeof __alloyId206.__transform["name"] ? __alloyId206.__transform["name"] : __alloyId206.get("name")
            });
            rows.push(__alloyId208);
            selectCategory ? __alloyId208.addEventListener("click", selectCategory) : __defers["__alloyId208!click!selectCategory"] = true;
        }
    ...
    var __alloyId209 = Alloy.Collections["categorie"] || categorie;
    __alloyId209.on("fetch destroy change add remove reset", syncCategorie);
    exports.destroy = function() {
        __alloyId209.off("fetch destroy change add remove reset", syncCategorie);
    };
    _.extend($, $.__views);
    ...
    __defers["__alloyId208!click!selectCategory"] && __alloyId208.addEventListener("click", selectCategory);
    _.extend($, exports);
}
