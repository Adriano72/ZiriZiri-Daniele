...
function Controller() {
    ...
    $.__views.row.add($.__views.__alloyId252);
    ...
    $.__views.__alloyId252.add($.__views.timestamp);
    ...
    $.__views.row.add($.__views.__alloyId254);
    ...
    $.__views.__alloyId254.add($.__views.content);
