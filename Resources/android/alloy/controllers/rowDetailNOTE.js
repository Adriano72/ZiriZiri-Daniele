function Controller() {
    ...
    $.__views.rowDetailNOTE.add($.__views.__alloyId50);
    ...
    $.__views.rowDetailNOTE.add($.__views.__alloyId51);
    ...
    $.__views.__alloyId51.add($.__views.category);
    $.__views.__alloyId52 = Ti.UI.createTableViewRow({
        id: "__alloyId52"
    });
    $.__views.rowDetailNOTE.add($.__views.__alloyId52);
    ...
    $.__views.__alloyId52.add($.__views.timestamp);
    $.__views.__alloyId53 = Ti.UI.createTableViewRow({
        id: "__alloyId53"
    });
    $.__views.rowDetailNOTE.add($.__views.__alloyId53);
    ...
    $.__views.__alloyId53.add($.__views.content);
