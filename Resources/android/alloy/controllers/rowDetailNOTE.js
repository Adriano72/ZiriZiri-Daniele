...
function Controller() {
    ...
    $.__views.row.add($.__views.__alloyId192);
    ...
    $.__views.__alloyId192.add($.__views.timestamp);
    ...
    $.__views.row.add($.__views.__alloyId194);
    ...
    $.__views.__alloyId194.add($.__views.content);
