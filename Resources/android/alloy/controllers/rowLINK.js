...
function Controller() {
    ...
    $.__views.row.add($.__views.__alloyId236);
    ...
    $.__views.__alloyId236.add($.__views.titolo);
    ...
    $.__views.__alloyId236.add($.__views.descrizione);
    ...
    $.__views.row.add($.__views.__alloyId237);
    ...
    $.__views.__alloyId237.add($.__views.content);
