...
function Controller() {
    ...
    $.__views.row.add($.__views.__alloyId203);
    ...
    $.__views.__alloyId203.add($.__views.titolo);
    ...
    $.__views.__alloyId203.add($.__views.descrizione);
    ...
    $.__views.row.add($.__views.__alloyId204);
    ...
    $.__views.__alloyId204.add($.__views.content);
