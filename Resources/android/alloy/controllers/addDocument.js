function Controller() {
    function __alloyId14() {
        $.__views.window.removeEventListener("open", __alloyId14);
        if ($.__views.window.activity) $.__views.window.activity.onCreateOptionsMenu = function(e) {
            ...
            $.__views.salva = e.menu.add(_.pick(__alloyId13, Alloy.Android.menuItemCreateArgs));
            $.__views.salva.applyProperties(_.omit(__alloyId13, Alloy.Android.menuItemCreateArgs));
    ...
    $.__views.window.addEventListener("open", __alloyId14);
    var __alloyId15 = [];
    ...
    $.__views.__alloyId16.add($.__views.titolo);
    ...
    $.__views.__alloyId17.add($.__views.descrizione);
    ...
    $.__views.__alloyId18.add($.__views.foto);
    ...
    $.__views.__alloyId19.add($.__views.gallery);
    ...
    $.__views.__alloyId20.add($.__views.preview);
