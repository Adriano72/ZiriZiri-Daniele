...
zz.Internal.API.Finance.PaymentModes.list = function(successCallback, errorCallback) {
    ...
    var storedDatas = zzLocalDB.ZZ.Internal.Local.DB.Datas.findByUserRefAndTypeAndAliasAndStatusAndAction(user.id, zzLocalDB.ZZ.Internal.Local.DB.Data.CONSTANTS.TYPES.COLLECTION, zzLocalDB.ZZ.Internal.Local.DB.Data.CONSTANTS.ALIASES.PAYMENTMODES, zzLocalDB.ZZ.Internal.Local.DB.Data.CONSTANTS.STATUSES.CACHED, zzLocalDB.ZZ.Internal.Local.DB.Data.CONSTANTS.ACTIONS.NONE);
    var objs = [];
    null != storedDatas && storedDatas.length > 0 && _.each(storedDatas, function(storedData) {
        var obj = JSON.parse(storedData.serialized_data);
...
zz.Internal.API.Finance.CashflowStatuses.list = function(successCallback, errorCallback) {
    ...
    var storedDatas = zzLocalDB.ZZ.Internal.Local.DB.Datas.findByUserRefAndTypeAndAliasAndStatusAndAction(user.id, zzLocalDB.ZZ.Internal.Local.DB.Data.CONSTANTS.TYPES.COLLECTION, zzLocalDB.ZZ.Internal.Local.DB.Data.CONSTANTS.ALIASES.CASHFLOWSTATUSES, zzLocalDB.ZZ.Internal.Local.DB.Data.CONSTANTS.STATUSES.CACHED, zzLocalDB.ZZ.Internal.Local.DB.Data.CONSTANTS.ACTIONS.NONE);
    var objs = [];
    null != storedDatas && storedDatas.length > 0 && _.each(storedDatas, function(storedData) {
        var obj = JSON.parse(storedData.serialized_data);
...
zz.Internal.API.Finance.PaymentTakingTools.list = function(successCallback, errorCallback) {
    ...
    var storedDatas = zzLocalDB.ZZ.Internal.Local.DB.Datas.findByUserRefAndTypeAndAliasAndStatusAndAction(user.id, zzLocalDB.ZZ.Internal.Local.DB.Data.CONSTANTS.TYPES.COLLECTION, zzLocalDB.ZZ.Internal.Local.DB.Data.CONSTANTS.ALIASES.PAYMENTTAKINGTOOLS, zzLocalDB.ZZ.Internal.Local.DB.Data.CONSTANTS.STATUSES.CACHED, zzLocalDB.ZZ.Internal.Local.DB.Data.CONSTANTS.ACTIONS.NONE);
    var objs = [];
    null != storedDatas && storedDatas.length > 0 && _.each(storedDatas, function(storedData) {
        var obj = JSON.parse(storedData.serialized_data);
...
zz.Internal.API.Finance.CashflowTypes.list = function(successCallback, errorCallback) {
    ...
    var storedDatas = zzLocalDB.ZZ.Internal.Local.DB.Datas.findByUserRefAndTypeAndAliasAndStatusAndAction(user.id, zzLocalDB.ZZ.Internal.Local.DB.Data.CONSTANTS.TYPES.COLLECTION, zzLocalDB.ZZ.Internal.Local.DB.Data.CONSTANTS.ALIASES.CASHFLOWTYPES, zzLocalDB.ZZ.Internal.Local.DB.Data.CONSTANTS.STATUSES.CACHED, zzLocalDB.ZZ.Internal.Local.DB.Data.CONSTANTS.ACTIONS.NONE);
    var objs = [];
    null != storedDatas && storedDatas.length > 0 && _.each(storedDatas, function(storedData) {
        var obj = JSON.parse(storedData.serialized_data);
...
zz.Internal.API.Finance.CashflowVariabilities.list = function(successCallback, errorCallback) {
    ...
    var storedDatas = zzLocalDB.ZZ.Internal.Local.DB.Datas.findByUserRefAndTypeAndAliasAndStatusAndAction(user.id, zzLocalDB.ZZ.Internal.Local.DB.Data.CONSTANTS.TYPES.COLLECTION, zzLocalDB.ZZ.Internal.Local.DB.Data.CONSTANTS.ALIASES.CASHFLOWVARIABILITIES, zzLocalDB.ZZ.Internal.Local.DB.Data.CONSTANTS.STATUSES.CACHED, zzLocalDB.ZZ.Internal.Local.DB.Data.CONSTANTS.ACTIONS.NONE);
    var objs = [];
    null != storedDatas && storedDatas.length > 0 && _.each(storedDatas, function(storedData) {
        var obj = JSON.parse(storedData.serialized_data);
...
zz.Internal.API.Finance.CashflowCurrencies.list = function(successCallback, errorCallback) {
    ...
    var storedDatas = zzLocalDB.ZZ.Internal.Local.DB.Datas.findByUserRefAndTypeAndAliasAndStatusAndAction(user.id, zzLocalDB.ZZ.Internal.Local.DB.Data.CONSTANTS.TYPES.COLLECTION, zzLocalDB.ZZ.Internal.Local.DB.Data.CONSTANTS.ALIASES.CASHFLOWCURRENCIES, zzLocalDB.ZZ.Internal.Local.DB.Data.CONSTANTS.STATUSES.CACHED, zzLocalDB.ZZ.Internal.Local.DB.Data.CONSTANTS.ACTIONS.NONE);
    var objs = [];
    null != storedDatas && storedDatas.length > 0 && _.each(storedDatas, function(storedData) {
        var obj = JSON.parse(storedData.serialized_data);
