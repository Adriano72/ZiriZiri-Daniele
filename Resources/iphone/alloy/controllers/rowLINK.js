...
function Controller() {
    ...
    $.__views.row.add($.__views.__alloyId209);
    ...
    $.__views.__alloyId209.add($.__views.titolo);
    ...
    $.__views.__alloyId209.add($.__views.descrizione);
    ...
    $.__views.row.add($.__views.__alloyId210);
    ...
    $.__views.__alloyId210.add($.__views.content);
