...
function Controller() {
    ...
    $.__views.__alloyId151.add($.__views.addPeopleImage);
    ...
    $.__views.__alloyId151.add($.__views.addPeople);
    ...
    getLocation ? $.__views.__alloyId152.addEventListener("click", getLocation) : __defers["$.__views.__alloyId152!click!getLocation"] = true;
    ...
    $.__views.__alloyId153.add($.__views.locationImage);
    ...
    $.__views.__alloyId153.add($.__views.location);
    ...
    __alloyId143.push($.__views.__alloyId154);
    ...
    toggleScadStrutt ? $.__views.__alloyId155.addEventListener("click", toggleScadStrutt) : __defers["$.__views.__alloyId155!click!toggleScadStrutt"] = true;
    $.__views.leftSubWrapper = Ti.UI.createView({
        width: "50%",
        layout: "horizontal",
        left: 0,
    ...
    $.__views.__alloyId155.add($.__views.leftSubWrapper);
    ...
    $.__views.__alloyId155.add($.__views.ovalSwitchContainer);
    ...
    __defers["$.__views.__alloyId152!click!getLocation"] && $.__views.__alloyId152.addEventListener("click", getLocation);
    __defers["$.__views.__alloyId155!click!toggleScadStrutt"] && $.__views.__alloyId155.addEventListener("click", toggleScadStrutt);
    _.extend($, exports);
}
