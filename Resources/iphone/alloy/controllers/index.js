...
function Controller() {
    ...
    $.__views.index.add($.__views.__alloyId143);
    ...
    $.__views.__alloyId143.add($.__views.password);
    ...
    $.__views.__alloyId143.add($.__views.btn_login);
    ...
    $.__views.index.add($.__views.__alloyId144);
    ...
    $.__views.__alloyId144.add($.__views.remember);
    ...
    $.__views.__alloyId144.add($.__views.forgotPassword);
