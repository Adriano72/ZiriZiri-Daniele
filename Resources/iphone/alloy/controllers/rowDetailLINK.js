...
function Controller() {
    ...
    $.__views.__alloyId162.add($.__views.tags);
    ...
    $.__views.row.add($.__views.__alloyId164);
    ...
    $.__views.__alloyId164.add($.__views.type);
    ...
    $.__views.row.add($.__views.__alloyId166);
    ...
    $.__views.__alloyId166.add($.__views.content);
    ...
    $.__views.row.add($.__views.__alloyId168);
